...
public class ConvertIntent
{
    ...
    /// <summary>When the `close` tag write actually completed (or was found already present). Null until written; the write job keys off this + State=Paid.</summary>
    public DateTimeOffset? CloseTagWrittenAt { get; set; }
